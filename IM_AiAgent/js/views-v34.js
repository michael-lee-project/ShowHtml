...
function renderAiDemoStep(step, idx, c, demo) {
  ...
  if (step.type === 'semi-options') {
    // 半自动化：AI输出3个可选思路，点击选择后AI再回复
    return `
      <div class="msg-row me ai-demo-msg demo-step" style="--d:${delay}s;">
        <div class="msg-agent-badge">AI</div>
        <div class="semi-options-bubble me">
